...
<form
	action="<?php echo Route::_('index.php?option=com_gavoting&view=nomination&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'nomination')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'nomination', Text::_('COM_GAVOTING_TAB_NOMINATION', true)); ?>
	<div class="row-fluid">
