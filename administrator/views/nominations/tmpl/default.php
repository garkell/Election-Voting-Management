...
if ($saveOrder)
{
    ...
    HTMLHelper::_('sortablelist.sortable', 'nominationList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo Route::_('index.php?option=com_gavoting&view=nominations'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="nominationList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<td>
						...
						<td class="center">
							<?php if ($item->agreed == 1) { echo '<i class="icon-publish"></i>';} ?>
						</td>
						<td class="center">
							<?php echo $item->votes; ?>
						</td>
