...
<form
	...
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'position')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'position', empty($this->item->id) ? Text::_('COM_GAVOTING_TAB_POSITION_NEW') : Text::_('COM_GAVOTING_TAB_POSITION_EDIT')); ?>
	<div class="row-fluid">
