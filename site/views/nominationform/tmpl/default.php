	...
	<?php else : ?>
		...
		<?php else : ?>
			...
			<form id="form-nomination"
				...
				<?php echo HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('active' => 'nomination')); ?>
				<?php echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'nomination', Text::_('COM_GAVOTING_TAB_NOMINATION', true)); ?>
				<div class="row-fluid">
